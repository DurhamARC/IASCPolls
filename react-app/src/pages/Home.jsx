        ...
        <div className="home-pic-3">
          <div className="home--about--overlay">
            <div className="home--about--text">
              <h2>What is IASC?</h2>
              <h3>
              The Institute for Ascertaining Scientific Consensus (IASC) is a global
              network that can email over 100,000 scientists with a specific
              statement of interest, such as &ldquo;Covid is caused by a
              virus&rdquo;, and request an agree/disagree response within two
              minutes. The responses will be instantly and anonymously recorded in a
              database, allowing for the calculation of the strength of consensus.
              This network will be a valuable resource for policymakers and the
              general public in discerning the level of agreement among scientists
