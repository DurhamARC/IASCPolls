      ...
      <div className="ethics--container">
       <div className="ethics--content">
           ...
           <div>
               ...
               <h3>Votes are anonymous. Votes are not connected to a voter, nor even to a unique voting token.</h3>
               <p>
               ...
               <p>Although the survey invitation emails are sent from various different local institutions, the data itself goes directly to the project hub (Durham, UK). The spoke representatives in the IASC hub-and-spoke network, who send the emails, cannot access any data. This includes knowledge of who has/hasn’t chosen to participate at their own institution.
               </p>


               <h3>What encryption method is used?</h3>
               <p>Responses are encrypted with an https:// secure connection.
               </p>


               <h3>Does this project have ethics approval?</h3>
               <p>This project has full ethics approval from Durham University (UK), equivalent to IRB in the US.
               </p>                 


               <h3>What will be done with the collected data?</h3>
               <p>Data is collected purely for the purposes of ascertaining strength of scientific community opinion, regarding a given statement of interest.
               </p>                 


               <h3>Why aren’t targeted scientists given the opportunity to “unsubscribe”?</h3>
               <p>Targeted scientists aren’t subscribed to anything. They will be emailed only twice during the 2022-23 academic year, with the email coming from somebody internal to their own institution.
               </p>                 
